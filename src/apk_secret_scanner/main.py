...
from .apk_secret_scanner import APKSecretScanner
...
DEFAULT_RULES = [
    ...
    # default_rule_path("rules-stable.yml"),
    # default_rule_path("gitleaks.toml"),

    # default_rule_path("regexes.json"),
    # default_rule_path("notkeyhacks.json"),
]
...
def main():
    ...
    output_options.add_argument("-o", "--output", type=Path, metavar="SECRETS_OUTPUT_FILE", help="Output file for secrets found.")
    ...
    apk_secret_scanner = APKSecretScanner(
    ...
    try:
        results = apk_secret_scanner.decompile_and_scan(args.files)
